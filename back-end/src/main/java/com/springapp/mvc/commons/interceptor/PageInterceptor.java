package com.springapp.mvc.commons.interceptor;
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (mappedStatement.getId().matches(pageSqlId)) {
            ...
            if (parameterObject == null) {
                ...
                //增加排序条件
                Map parameterMap = (Map)metaStatementHandler
                        .getValue("delegate.boundSql.parameterObject.map");
                Object order = parameterMap.get("order");
